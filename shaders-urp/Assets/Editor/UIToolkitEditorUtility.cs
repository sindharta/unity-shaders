...
//----------------------------------------------------------------------------------------------------------------------
    ...
    {
	    VisualElement templateInstance = CloneFieldTemplate();
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------	
	...
	private static VisualElement CloneFieldTemplate() {
		
		VisualElement visualElement = new VisualElement() { name = "FieldContainer"};
